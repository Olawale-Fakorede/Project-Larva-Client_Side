...
// useEffect(() => {
  axios.get('http://localhost:6040/api/tutors')
    .then(response => {
      console.log(response.data);
      setGetTutor(response.data);
    })
    .catch(error => {
      console.error(error);
    });
// }, []);
  ...
  return (
    <div className="w-[1300px] h-[781px] relative bg-[#f9f9f9]">
        ...
        <div className="text-[#111111] text-xl font-semibold font-['Inter']">Tutors Page</div>
        <div className="justify-start items-center gap-[31px] flex">
            <div className="w-[140px] flex-col justify-start items-start gap-2 inline-flex">
                <div className="self-stretch text-[#333333] text-lg font-medium font-['Inter']">Admin</div>
                <div className="self-stretch text-[#666666] text-sm font-medium font-['Inter']">Head of Schools</div>
            </div>
    ...
    <aside className="pl-11 pr-16 pt-[37px] pb-[62.62px] left-0 top-0 absolute bg-white border-r border-[#e6e6e6] flex-col justify-start items-center inline-flex">
        <div className="self-stretch h-[681.38px] flex-col justify-start items-start gap-[100px] inline-flex">
            <div className="h-[375.38px] flex-col justify-start items-start gap-[120px] flex">
                ...
                <div className="self-stretch h-[196px] flex-col justify-start items-start gap-10 flex">
                    ...
                    <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
                        <div className="text-[#222222] text-base font-semibold font-['Inter']" onClick={handleRegister}>Register Tutor</div>
                    </div>
                    <div className="justify-center items-center gap-2.5 inline-flex">
                        <div className="text-[#cc781d] text-base font-semibold font-['Inter']" onClick={handleTutor}>Tutor List</div>
                    </div>
                    <div className="justify-center items-center gap-2.5 inline-flex">
    ...
    <div className="h-[215px] pl-[30px] pr-[37px] py-5 left-[247px] top-[82px] absolute border-b border-[#e6e6e6] flex-col justify-start items-start gap-[29px] inline-flex">
        <div className="self-stretch h-[91px] flex-col justify-start items-center gap-[18px] flex">
            <div className="self-stretch text-center text-[#1a1a1a] text-lg font-semibold font-['Inter']">Tutors List</div>
    ...
    <div className="w-[1003px] px-6 left-[277px] top-[325px] absolute justify-between items-center inline-flex">
             ...
             {getTutor.map((tut) => (
                <div className='text-black font-bold font-[inter] border-1 rounded-md items-center'>
                    <h1>{tut.name}</h1>
                    <p>{tut.email}</p>
                    <p>{tut.course}</p>
                    <p>{tut.phone}</p>
